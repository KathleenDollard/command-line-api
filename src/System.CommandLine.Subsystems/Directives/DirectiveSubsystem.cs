...
public abstract class DirectiveSubsystem : CliSubsystem
{
    ...
    public DirectiveSubsystem(string name, SubsystemKind kind, SubsystemPhase phase, IAnnotationProvider? annotationProvider = null, string? id = null)
        : base(name, kind, phase, annotationProvider: annotationProvider)
    {
        Id = id ?? name;
    }
