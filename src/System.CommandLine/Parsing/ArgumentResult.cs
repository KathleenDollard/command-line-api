        ...
        private ArgumentConversionResult ValidateAndConvert(bool useValidators)
        {
            ...
            */
            ...
            ArgumentConversionResult ReportErrorIfNeeded(ArgumentConversionResult result)
            {
                ...
                {
                    SymbolResultTree.AddError(new CliDiagnostic(new("ArgumentConversionResultTypeFailed", "Type Conversion Failed", result.ErrorMessage!, CliDiagnosticSeverity.Warning, null), [], valueResult: ValueResult));
                }
