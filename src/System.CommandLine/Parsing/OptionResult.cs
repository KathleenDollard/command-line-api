        ...
        public ValueResult ValueResult
        {
            get
            {
                if (_valueResult is null)
                {
                    ...
                    _valueResult = new ValueResult(Option, conversionValue, locations, ValueResultExtensions.GetValueResultOutcome(ArgumentConversionResult?.Result), identifireLocation: IdentifierToken?.Location); // null is temporary here
                }
                return _valueResult;
            }
        }
