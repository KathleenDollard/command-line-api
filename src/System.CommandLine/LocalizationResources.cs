...
namespace System.CommandLine
{
    ...
    public static class LocalizationResources
    {
        ...
        /// </summary>
        public static string ExpectsOneArgument(OptionResult optionResult)
        ...
        /// </summary>
        public static string DirectoryDoesNotExist(string path) =>
        ...
        /// </summary>
        public static string FileOrDirectoryDoesNotExist(string path) =>
        ...
        /// </summary>
        public static string InvalidCharactersInPath(char invalidChar) =>
        ...
        /// </summary>
        public static string InvalidCharactersInFileName(char invalidChar) =>
        ...
        /// </summary>
        public static string RequiredArgumentMissing(ArgumentResult argumentResult) =>
        ...
        /// </summary>
        public static string RequiredArgumentMissing(OptionResult optionResult) =>
        ...
        /// </summary>
        public static string RequiredCommandWasNotProvided() =>
        ...
        /// </summary>
        public static string RequiredOptionWasNotProvided(string longestAliasWithPrefix) =>
        ...
        /// </summary>
        public static string UnrecognizedArgument(string unrecognizedArg, IReadOnlyCollection<string> allowedValues) =>
        ...
        /// </summary>
        public static string UnrecognizedCommandOrArgument(string arg) =>
        ...
        /// </summary>
        public static string ResponseFileNotFound(string filePath) =>
        ...
        /// </summary>
        public static string ErrorReadingResponseFile(string filePath, IOException e) =>
        ...
        /// </summary>
        public static string HelpOptionDescription() =>
        ...
        /// </summary>
        public static string SuggestionsTokenNotMatched(string token)
        ...
        /// </summary>
        public static string VersionOptionCannotBeCombinedWithOtherArguments(string optionAlias)
        ...
        /// </summary>
        public static string ExceptionHandlerHeader()
        ...
        /// </summary>
        public static string ArgumentConversionCannotParse(string value, Type expectedType)
        ...
        /// </summary>
        public static string ArgumentConversionCannotParseForCommand(string value, string commandAlias, Type expectedType)
            => GetResourceString(Properties.Resources.ArgumentConversionCannotParseForCommand, value, commandAlias, expectedType);

        /// <summary>
        ///   Interpolates values into a localized string similar to Cannot parse argument &apos;{0}&apos; for command &apos;{1}&apos; as expected type {2}..
        /// </summary>
        public static string ArgumentConversionCannotParseForCommand(string value, string commandAlias, Type expectedType, IEnumerable<string> completions)
        ...
        /// </summary>
        public static string ArgumentConversionCannotParseForOption(string value, string optionAlias, Type expectedType)
            => GetResourceString(Properties.Resources.ArgumentConversionCannotParseForOption, value, optionAlias, expectedType);

        /// <summary>
        ///   Interpolates values into a localized string similar to Cannot parse argument &apos;{0}&apos; for option &apos;{1}&apos; as expected type {2}..
        /// </summary>
        public static string ArgumentConversionCannotParseForOption(string value, string optionAlias, Type expectedType, IEnumerable<string> completions)
