...
namespace System.CommandLine.Tests.Help
{
    public partial class HelpBuilderTests
    {
        ...
        private readonly CliHelpBuilder _helpBuilder;
        ...
        private CliConfiguration GetCliConfiguration(CliCommand command)
        {
            ...
            config.AddConfiguration(new HelpConfiguration());
            return config;
        }
        ...
        public void Synopsis_section_keeps_added_newlines()
        {
            ...
            _helpBuilder.Write(GetHelpContext(command, LargeMaxWidth, _console));
        ...
        [Fact]
        // KAD: This test appears to be misnamed. I believe it is Command_name_in_usage_can_be_specified
        ...
        {
            // KAD: Why is CliCommand.Parents a collection because it seems to just hold null or the parent
            ...
            _helpBuilder.Write(GetHelpContext(innerEr, LargeMaxWidth, _console));
        ...
        public void Usage_section_for_subcommand_shows_arguments_for_subcommand_and_parent_command()
        {
            ...
            _helpBuilder.Write(GetHelpContext(inner, LargeMaxWidth, _console));
        ...
        public void Usage_section_does_not_show_additional_arguments_when_TreatUnmatchedTokensAsErrors_is_true()
        {
            ...
            _helpBuilder.Write(GetHelpContext(subcommand, LargeMaxWidth, _console));
        ...
        public void Usage_section_keeps_added_newlines()
        {
            ...
            _helpBuilder.Write(GetHelpContext(outer, LargeMaxWidth, _console));
        ...
        public void Usage_section_properly_wraps_description()
        {
            ...
            helpBuilder.Write(GetHelpContext(outerCommand, SmallMaxWidth, _console));
        ...
        {
            _helpBuilder.Write(GetHelpContext(new CliRootCommand(), LargeMaxWidth, _console));
        ...
        public void Arguments_section_keeps_added_newlines_when_width_is_very_small()
        {
            ...
            helpBuilder.Write(GetHelpContext(command, 25, _console));
        ...
        public void Options_section_is_not_included_if_no_options_configured()
        {
            ...
            _helpBuilder.Write(GetHelpContext(commandLineBuilder, 0, _console));
        ...
        {
            var configuration = new CliInvokableConfiguration(new CliRootCommand());
            configuration. AddConfiguration(new HelpConfiguration(), configuration.RootCommand);
        ...
        public void Commands_without_arguments_do_not_produce_extra_newlines_between_usage_and_options_sections()
        {
            ...
            helpBuilder.Write(GetHelpContext(command, 0, writer));
