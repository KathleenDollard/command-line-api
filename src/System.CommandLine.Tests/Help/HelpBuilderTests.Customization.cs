...
//            private CliHelpBuilder GetHelpBuilder(int maxWidth) => new (maxWidth);
...
//                _helpBuilder.Write(GetHelpContext(command, 0, _console));
//                var expected =
//                    $"Options:{NewLine}" +
...
//                var helpBuilder = new CliHelpBuilder(LargeMaxWidth);
...
//            {
//                Action action = () => new CliHelpBuilder().CustomizeSymbol(null!, "");
...
//                var helpBuilder = new CliHelpBuilder(HelpConfiguration.MaxWidht(LargeMaxWidth));
//                helpBuilder.CustomizeSymbol(option,
//                    firstColumnText: ctx => conditionA ? "custom 1st" : CliHelpBuilder.Default.GetOptionUsageLabel(option),
...
//                    firstColumnText: ctx => conditionA ? "custom 1st" : CliHelpBuilder.Default.GetArgumentUsageLabel(argument),
//                    secondColumnText: ctx => conditionB ? "custom 2nd" : CliHelpBuilder.Default.GetArgumentDescription(argument),
//                    defaultValue: ctx => conditionC ? "custom def" : CliHelpBuilder.Default.GetArgumentDefaultValue(argument));
...
//                    foreach (var section in CliHelpBuilder.Default.GetLayout())
//                    {
...
//            {
//                CliHelpBuilder helpBuilder = new();
...
//                                                    ? CliHelpBuilder.Default.GetLayout()
//                                                    : new Action<HelpContext>[]
//                                                        {
//                                                            c => c.Output.WriteLine("Custom layout!")
//                                                        }
//                                                        .Concat(CliHelpBuilder.Default.GetLayout()));
...
//                if (parseResult.Action is HelpAction helpAction)
//                {
//                    helpAction.Builder = new CliHelpBuilder(10);
//                    helpAction.Builder.CustomizeLayout(CustomLayout);
//                }
...
//                IEnumerable<Action<HelpContext>> CustomLayout(HelpContext _)
//                {
//                    yield return ctx => ctx.CliHelpBuilder.WriteColumns(new[] { new TwoColumnHelpRow("12345678", "1234567890") }, ctx);
//                }
//            }
