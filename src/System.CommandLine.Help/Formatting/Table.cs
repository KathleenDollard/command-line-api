...
namespace System.CommandLine.Help.Formatting
{
    ...
    public class Table<T>
    {
                                                           ...
                                                           int[]? headerWidths = null)
        {
            ...
            static IEnumerable<string> PadTableOutput(IEnumerable<string>[,] wrappedCellText,
            ...
            static int GetMaxNumberOfLinesInRow(IEnumerable<string>[,] wrappedCellText, int row)
            {
                var maxLines = 0;
            ...
            static IEnumerable<string>[,] WrapColumns(string[,] allCellText, int[] currentColumnWidths, int usableWidth)
            {
                ...
                for (int col = 0; col < currentColumnWidths.Length; col++)
                {
                    ...
                    {
                        UpdateTextToCurrent(allCellText, wrappedCellText, col);
                    }
                    else
                    {
            ...
            static int GetFairWidth(int[] currentColumnWidths, int remainingWidth, int remainingColumns)
            {
